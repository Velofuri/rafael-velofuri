...
export default function Footer() {
  return (
    <footer
      id='contato'
      className='footer border z-10 border-t-zinc-700 border-l-transparent border-r-transparent text-white'
    >
      <div className='px-12 py-6 flex flex-col gap-6 justify-around'>
        <div className='flex flex-col gap-4 sm:flex-row items-center justify-around'>
          <div>
            <Link href={'/'}>
              <Image src={'/images/rv1.png'} alt='logo RV' width={45} height={45} />
            </Link>
          </div>
          <div>
            <div className='flex items-center justify-center gap-2'>
              <EnvelopeClosedIcon />
              <Link href={'mailto:velofuri@gmail.com'}>velofuri@gmail.com</Link>
            </div>
            <div className='flex items-center justify-center gap-2'>
              <svg
